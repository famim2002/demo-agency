    ...
    <section className="px-3 py-20 overflow-hidden bg-brandColor ">
      <div className="container">
        <div className="flex flex-col gap-y-32">
          <div className="">
            <h2
              className="text-[75px] text-primary font-extrabold text-prmiaryColor font-headerFont max-w-2xl 
          ...
          >
            ...
            <ChargeCards image="/icon-3.jpg" title="End-to-End Team" className="mx-auto">
