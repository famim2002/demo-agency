    ...
    <section className="px-3 py-20">
      <div className="container">
        ...
        >
          ...
          <div
            className="relative max-w-sm  m-auto "
          >
            <img className=" rotate-90
          lg:rounded-bl-[40%] lg:rotate-0" src="/idea.jpg" alt="" />
            <div className="absolute px-10 mx-auto py-15 bg-stone-100 translate-y-[-250px] 
            sm:translate-x-[90px]
              lg:rounded-bl-[40%]">
